            ...
            <div class="container">
                <div class="breadcrumb-content">
                    <ul>
                        ...
                        <li class="active">Home Made Kannakaya Powder</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="product-details-img">
                        ...
                        <div class="single-product-img swiper-container product-gallery-top">
                            <div class="swiper-wrapper popup-gallery">
                                <a class="swiper-slide w-100" href="{{url('public/assets/images/products/d.png')}}">
                                    <img class="w-100" src="{{url('public/assets/images/products/d.png')}}">
                                </a>
                                <a class="swiper-slide w-100" href="{{url('public/assets/images/products/d.png')}}">
                                    <img class="w-100" src="{{url('public/assets/images/products/d.png')}}" alt="Product">
                                </a>
                                <a class="swiper-slide w-100" href="{{url('public/assets/images/products/d.png')}}">
                                    <img class="w-100" src="{{url('public/assets/images/products/d.png')}}" alt="Product">
                                </a>
                        ...
                        <div class="single-product-thumb swiper-container product-gallery-thumbs">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="{{url('public/assets/images/products/d.png')}}" alt="Product">
                                </div>
                                <div class="swiper-slide">
                                    <img src="{{url('public/assets/images/products/d.png')}}" alt="Product">
                                </div>
                ...
                <div class="col-lg-7">
                    ...
                    <div class="product-summery position-relative">
                        ...
                        <div class="product-head mb-3">
                            <h2 class="product-title">Home Made Kannakaya Powder</h2>
                        </div>
                        <!-- Product Head End -->
                    ...
                    <div class="tab-content mb-text" id="myTabContent">
                        <div class="tab-pane fade show active" id="connect-1" role="tabpanel" aria-labelledby="home-tab">
                            <div class="desc-content p-3">
                                <p class="mb-3">Kannan kaya powder, also known as ripe banana powder, is a type of baby food that is made from ripe bananas that have been dried and ground into a fine powder. It is a popular food for infants and young children in many parts of the world, including South Asia and Africa.

                                    <p>There are several benefits of using kannan kaya powder as a baby food:<br>
                                        1.  Nutritious: Kannan kaya powder is a good source of nutrients, including fiber, potassium, vitamin C, and vitamin B6. These nutrients are important for a child's growth and development.<br>
                                        2.  Easy to digest: Kannan kaya powder is easily digestible, making it a good option for infants and young children who may have difficulty digesting other foods.<br>
                                        3.  Convenient: Kannan kaya powder can be easily stored and prepared, making it a convenient option for busy parents.<br>
                                        4.  Versatile: Kannan kaya powder can be mixed with other foods, such as milk or yogurt, to create a variety of nutritious and tasty meals for infants and young children.<br>
                                    5.  Allergen-free: Kannan kaya powder is free from common allergens, such as gluten, dairy, and soy, making it a good option for infants and young children who may have food sensitivities or allergies.</p>
