            ...
            <div class="container">
                <div class="breadcrumb-content">
                    <ul>
                        ...
                        <li class="active">Home Made Banana Powder</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="product-details-img">
                        ...
                        <div class="single-product-img swiper-container product-gallery-top">
                            <div class="swiper-wrapper popup-gallery">
                                <a class="swiper-slide w-100" href="{{url('public/assets/images/products/b.png')}}">
                                    <img class="w-100" src="{{url('public/assets/images/products/b.png')}}">
                                </a>
                                <a class="swiper-slide w-100" href="{{url('public/assets/images/products/b.png')}}">
                                    <img class="w-100" src="{{url('public/assets/images/products/b.png')}}" alt="Product">
                                </a>
                                <a class="swiper-slide w-100" href="{{url('public/assets/images/products/b.png')}}">
                                    <img class="w-100" src="{{url('public/assets/images/products/b.png')}}" alt="Product">
                                </a>
                        ...
                        <div class="single-product-thumb swiper-container product-gallery-thumbs">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="{{url('public/assets/images/products/b.png')}}" alt="Product">
                                </div>
                                <div class="swiper-slide">
                                    <img src="{{url('public/assets/images/products/b.png')}}" alt="Product">
                                </div>
                ...
                <div class="col-lg-7">
                    ...
                    <div class="product-summery position-relative">
                        ...
                        <div class="product-head mb-3">
                            <h2 class="product-title">Home Made Banana Powder</h2>
                        </div>
                        <!-- Product Head End -->
                    ...
                    <div class="tab-content mb-text" id="myTabContent">
                        <div class="tab-pane fade show active" id="connect-1" role="tabpanel" aria-labelledby="home-tab">
                            <div class="desc-content p-3">
                                <p class="mb-3">Banana powder is made from dried bananas. It is commonly used as a nutritional supplement for infants and young children, and it can also be used as an ingredient in various recipes.</p>
                                <p>The process of making banana powder involves first selecting ripe bananas, which are then peeled and sliced. The slices are then dried using a variety of methods, such as sun-drying or using a dehydrator. However, Mila Foods is dried through dehydrator. Once the slices are completely dry, they are ground into a fine powder. as an ingredient in various recipes.</p>
                                <p>One of the benefits of using banana powder in baby food is that it is a good source of nutrients, including potassium, fiber, and vitamin C. It can also be used as a natural sweetener, which can help make the baby food more appealing to infants and young children.</p>
