            ...
            <div class="container">
                <div class="breadcrumb-content">
                    <ul>
                        ...
                        <li class="active">Home Made Ragi Powder</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="product-details-img">
                        ...
                        <div class="single-product-img swiper-container product-gallery-top">
                            <div class="swiper-wrapper popup-gallery">
                                <a class="swiper-slide w-100" href="{{url('public/assets/images/products/a.png')}}">
                                    <img class="w-100" src="{{url('public/assets/images/products/a.png')}}">
                                </a>
                                <a class="swiper-slide w-100" href="{{url('public/assets/images/products/a.png')}}">
                                    <img class="w-100" src="{{url('public/assets/images/products/a.png')}}" alt="Product">
                                </a>
                                <a class="swiper-slide w-100" href="{{url('public/assets/images/products/a.png')}}">
                                    <img class="w-100" src="{{url('public/assets/images/products/a.png')}}" alt="Product">
                                </a>
                        ...
                        <div class="single-product-thumb swiper-container product-gallery-thumbs">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="{{url('public/assets/images/products/a.png')}}" alt="Product">
                                </div>
                                <div class="swiper-slide">
                                    <img src="{{url('public/assets/images/products/a.png')}}" alt="Product">
                                </div>
                ...
                <div class="col-lg-7">
                    ...
                    <div class="product-summery position-relative">
                        ...
                        <div class="product-head mb-3">
                            <h2 class="product-title">Home Made Ragi Powder</h2>
                        </div>
                        <!-- Product Head End -->
                    ...
                    <div class="tab-content mb-text" id="myTabContent">
                        <div class="tab-pane fade show active" id="connect-1" role="tabpanel" aria-labelledby="home-tab">
                            <div class="desc-content p-3">
                                <p class="mb-3">Ragi powder is a type of powdered food that is made from the grain called finger millet, which is also known as ragi. It is a popular food for infants and young children in many parts of the world, including South Asia and Africa.</p>
                                <p>To make baby food ragi powder, the ragi grains are first cleaned and then roasted. Once the grains are roasted, they are ground into a fine powder. This powder can then be used to make a porridge or a cereal that is suitable for infants and young children.
                                One of the benefits of using baby food ragi powder is that it is a good source of nutrients, including calcium, iron, and fiber. It is also gluten-free, which makes it a good option for infants and young children who may have gluten sensitivities or allergies</p>
